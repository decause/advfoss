...
<div class="alert alert-info">
    ...
    <ul>
        ...
        <li>How does the code work?</li>
            <ul>
                <li>What are some of the best pieces of software you wrote?
                Why?</li>
...
<div class="alert alert-info">
    ...
    <ul>
        ...
        <li>Was your project packaged and distributed properly? Include links
        to your upstream distribution channel (i.e. pypi, npm, dub,
        etc...)</li>
    </ul>
    </div>
</div>
